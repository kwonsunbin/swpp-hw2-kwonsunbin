  ...
  data.forEach((record) => {
    ...
    function handleClick(e, name, gender) {
      ...
      if (
        ...
        // disable chart row
        preventShow =
          newRow.nextElementSibling.getAttribute('data-name') === name;
        newRow.parentNode.removeChild(newRow.nextElementSibling);
      }
      if (!preventShow) {
        // enable chart row
        const newChartRow = document
          .querySelector('#template-row-chart')
          .cloneNode(true);
        newChartRow.id = '';
        newChartRow.style.display = 'table-row';
        newChartRow.setAttribute('data-name', name);
        newRow.parentNode.insertBefore(newChartRow, newRow.nextElementSibling);
    ...
    child
      .querySelector('a')
      .addEventListener('click', (e) => handleClick(e, record.male, 'M'));
    child = child.nextElementSibling;
    ...
    child
      .querySelector('a')
      .addEventListener('click', (e) => handleClick(e, record.female, 'F'));
    child = child.nextElementSibling;
